...
| [`standalone/orrery`](standalone/orrery/) | standalone | canonical | 3 | `sessions`, `skill` | none | `contracts`, `csrf`, `fragments`, `pages`, `security`, `sessions`, `sse`, `tools` | yes | [`orrery`](../examples/standalone/orrery) |
...
| [`standalone/query_search`](standalone/query_search/) | standalone | canonical | 3 | — | optional | `forms`, `fragments`, `no-js`, `pages`, `query`, `routing`, `validation` | yes | [`query_search`](../examples/standalone/query_search) |
...
| [`standalone/webmcp_form`](standalone/webmcp_form/) | standalone | experimental | 2 | `sessions` | none | `csrf`, `forms`, `fragments`, `mutations`, `sessions`, `validation`, `webmcp` | yes | [`webmcp_form`](../examples/standalone/webmcp_form) |
