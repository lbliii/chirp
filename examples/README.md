...
| Feature | hello | todo | contacts | sse | dashboard | dashboard_live | hackernews | rag_demo | static_site | auth | ollama | tools | signup | upload | survey | wizard | search |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| `@app.route()` | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x | x |
