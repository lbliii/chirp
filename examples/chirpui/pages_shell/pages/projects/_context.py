...
PROJECTS = (
    {
        ...
        "changelog": (
            {"version": "2.4.1", "date": "2025-03-15", "description": "Fixed OOB region caching for nested routes"},
            {"version": "2.4.0", "date": "2025-03-01", "description": "Added shell action zones with merge/replace modes"},
            {"version": "2.3.0", "date": "2025-02-15", "description": "Suspense blocks for deferred content loading"},
        ),
    },
    {
        "slug": "beacon",
        ...
        "version": "1.2.0",
        "api_endpoints": (
            {"method": "GET", "path": "/api/search", "description": "Full-text search across projects"},
            {"method": "GET", "path": "/api/traces", "description": "List request traces"},
            {"method": "GET", "path": "/api/traces/:id", "description": "Get trace details"},
        ),
        "changelog": (
            {"version": "1.2.0", "date": "2025-03-10", "description": "Added fragment-safe history navigation"},
            {"version": "1.1.0", "date": "2025-02-20", "description": "Live search with debounce and highlight"},
            {"version": "1.0.0", "date": "2025-01-15", "description": "Initial release with request tracing"},
        ),
    },
    {
        "slug": "cosmos",
        ...
        "api_endpoints": (
            ...
            {"method": "POST", "path": "/api/dashboards/:id/widgets", "description": "Add widget to dashboard"},
        ),
        "changelog": (
            {"version": "0.3.0", "date": "2025-03-12", "description": "Nested suspense chains for widget loading"},
            {"version": "0.2.0", "date": "2025-02-28", "description": "Dashboard layout persistence"},
            {"version": "0.1.0", "date": "2025-02-01", "description": "Initial prototype with layout chains"},
        ),
    },
)
