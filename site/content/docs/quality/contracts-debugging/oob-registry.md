...
See [App Shells → Regions](/chirp/docs/build-apps/ui-extensions/app-shell/#regions-recommended-for-oob) for the
...
- [App Shells](/chirp/docs/build-apps/ui-extensions/app-shell/) — the regions pattern and shell actions
- [UI Layers & Shell Regions](/chirp/docs/build-apps/ui-extensions/ui-layers/) — vocabulary and swap scopes
- [RenderPlan Middleware](/chirp/docs/build-apps/request-pipeline/render-plan/) — inspecting the plan from middleware
