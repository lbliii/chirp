...
| `_meta.py` | Route metadata (title, section, breadcrumb_label, shell_mode). See [Route Contract](/chirp/docs/contracts/route-contract/). |
...
See the [Route Directory Contract](/chirp/docs/contracts/route-contract/) for the full reserved file vocabulary and [Route Directory Golden Path](/chirp/docs/guides/route-directory/) for recommended patterns.
