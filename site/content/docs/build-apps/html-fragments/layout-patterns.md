...
> See [Shells](/chirp/docs/build-apps/ui-extensions/shells/) for the decision table and the
...
- [[docs/build-apps/ui-extensions/shells|Shells]] — Pick the right root layout (boost, shell, app-shell) and the `hx-select` distinction
