...
- [x] Single Python version (3.14t) documented as the recommended comparison run
...
- [x] Add DB workload
- [x] Add Starlette, Litestar
- [x] Add 3.14 (GIL) vs 3.14t comparison commands and report metadata
