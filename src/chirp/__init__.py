...
_API_STATUS: dict[str, str] = {
    ...
    "requires": "stable",
    "is_safe_url": "stable",
    "SessionMiddleware": "stable",
    "SessionConfig": "stable",
    "SessionSignalMiddleware": "stable",
    "SessionSignalConfig": "stable",
    "get_session": "stable",
    "regenerate_session": "stable",
    ...
    "ShellActionsRenderer": "provisional",
    "HypermediaHandoff": "provisional",
    "FocusHandoff": "provisional",
    "TitleHandoff": "provisional",
    "AnnouncementHandoff": "provisional",
    "apply_handoff": "provisional",
...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "FileResponse": ("chirp.http.response", "FileResponse"),
    ...
    "SignalEmit": ("chirp.templating.returns", "SignalEmit"),
    ...
    "ShellActionsRenderer": ("chirp.pages.shell_actions", "ShellActionsRenderer"),
    "HypermediaHandoff": ("chirp.http.handoff", "HypermediaHandoff"),
    "FocusHandoff": ("chirp.http.handoff", "FocusHandoff"),
    "TitleHandoff": ("chirp.http.handoff", "TitleHandoff"),
    "AnnouncementHandoff": ("chirp.http.handoff", "AnnouncementHandoff"),
    "apply_handoff": ("chirp.http.handoff", "apply_handoff"),
    # Middleware
    ...
    # Auth
    "AuthConfig": ("chirp.middleware.auth", "AuthConfig"),
    "AuthMiddleware": ("chirp.middleware.auth", "AuthMiddleware"),
    "current_user": ("chirp.middleware.auth", "current_user"),
    "get_user": ("chirp.middleware.auth", "get_user"),
    "login": ("chirp.middleware.auth", "login"),
    "logout": ("chirp.middleware.auth", "logout"),
    # Sessions
    "SessionConfig": ("chirp.middleware.sessions", "SessionConfig"),
    "SessionMiddleware": ("chirp.middleware.sessions", "SessionMiddleware"),
    "SessionSignalConfig": ("chirp.middleware.session_signals", "SessionSignalConfig"),
    "SessionSignalMiddleware": ("chirp.middleware.session_signals", "SessionSignalMiddleware"),
    "get_session": ("chirp.middleware.sessions", "get_session"),
    "regenerate_session": ("chirp.middleware.sessions", "regenerate_session"),
    "secure_stack": ("chirp.middleware.stack", "secure_stack"),
    # Security
